<?php
    ...
    $query="SELECT firstname,lastname,prefferedname,category,dateOfBirth FROM user where  MONTH(dateOfBirth)=MONTH(CURRENT_DATE) AND  DAY(dateOfBirth)=DAY(CURRENT_DATE+ INTERVAL 1 day) AND personalemail!='xx'";
    $result = mysqli_query($con,$query);
			...
			if($result){
				...
				{
					echo "No Birthdays Tomorrow! ".mysqli_error($con);
				}
			}
?>
